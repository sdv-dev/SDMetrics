...
def test_primary_key_detection_metrics():
    ...
    with patch('sdmetrics.utils.HyperTransformer.fit_transform') as fit_transform_mock:
        with patch('sdmetrics.utils.HyperTransformer.transform') as transform_mock:
            # Setup
            ...
            fit_transform_mock.assert_called_with(expected_return_real)

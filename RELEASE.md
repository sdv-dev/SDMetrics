...
After the release is published on [public PyPI](https://pypi.org/project/sdmetrics/), Anacanoda will automatically open a [PR on conda-forge](https://github.com/conda-forge/sdmetrics-feedstock/pulls). Make sure the dependencies match and then merge the PR for the anaconda release to be published.

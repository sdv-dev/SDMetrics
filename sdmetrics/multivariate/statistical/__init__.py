...
the two databases.
"""
from sdmetrics.multivariate.statistical.bivariate import ContinuousDivergence, DiscreteDivergence
from sdmetrics.multivariate.statistical.univariate import CSTest, KSTest

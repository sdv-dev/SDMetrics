...
SDMetrics could always use more documentation, whether as part of the
official SDMetrics docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `SDMetrics` for local development.

1. Fork the `SDMetrics` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/SDMetrics.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed,
   this is how you set up your fork for local development::

    $ mkvirtualenv SDMetrics
    $ cd SDMetrics/
...
2. The tests that cover a module called ``sdmetrics/path/to/a_module.py``
   should be implemented in a separated module called
   ``tests/sdmetrics/path/to/test_a_module.py``.
...
To run a subset of tests::
    ...
    $ python -m pytest tests.test_sdmetrics
...
.. _GitHub issues page: https://github.com/sdv-dev/SDMetrics/issues
.. _Travis Build Status page: https://travis-ci.org/sdv-dev/SDMetrics/pull_requests
